<footer class="bg-gray-800 text-gray-300 pt-12 pb-8">
    <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <!-- About Us -->
            <div>
                <h5 class="text-lg font-semibold text-white mb-4">Về ElectroShop</h5>
                <p class="text-sm leading-relaxed">ElectroShop là điểm đến tin cậy cho mọi nhu cầu về đồ điện tử, mang đến sản phẩm chất lượng và dịch vụ tận tâm.</p>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="#" class="hover:text-white">Theo Dõi Đơn Hàng</a></li>
                    <li><a href="{{ route('account.dashboard') }}" class="hover:text-white">Tài Khoản Của Tôi</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p class="text-sm mb-3">Nhận thông tin về sản phẩm mới và khuyến mãi đặc biệt.</p>
                <form action="#" method="POST">
                    @csrf
                    <div class="flex">
                        <input type="email" name="email" placeholder="Địa chỉ email của bạn"
                               class="w-full px-3 py-2 text-gray-800 border border-gray-600 rounded-l-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent text-sm">
                        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-r-md hover:bg-indigo-700 text-sm focus:outline-none">Đăng Ký</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="border-t border-gray-700 pt-8 text-center text-sm">
            <p>© {{ date('Y') }} {{ config('app.name', 'ElectroShop') }}. Bảo lưu mọi quyền.</p>
            <p class="mt-1">Thiết kế và phát triển bởi [Tên của bạn/Công ty bạn]</p>
        </div>
    </div>
</footer>